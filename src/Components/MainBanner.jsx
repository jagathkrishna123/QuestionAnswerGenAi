...
const MainBanner = () => {
  return (
    ...
    // </div>
    <div className="w-full max-w-[1440px] min-h-[450px] mx-auto md:min-h-[600px] rounded-xl  bg-gradient-to-r from-[#d7eaff] via-[#b5d9ff] to-[#8bc8ff] p-4 shadow-2xl">
      <div className="text-center mt-20 mb-8">
        ...
        <form className="flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded-full overflow-hidden">
          ...
          />
          <button className="bg-blue-500 text-white px-8 py-2 m-1.5 rounded-full hover:scale-105 transition-all cursor-pointer">
            Search
          </button>
        </form>
      </div>
